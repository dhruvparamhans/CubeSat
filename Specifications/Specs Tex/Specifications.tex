...
\hline
\multicolumn{1}{|l|}{Peripheral} & \multicolumn{1}{l|}{Name of the port} & \multicolumn{1}{l|}{No. Port on MPU} & \multicolumn{1}{l|}{Logical State} & \multicolumn{1}{l|}{Alternate Function (AF)} & \multicolumn{1}{l|}{AF Details 1} & \multicolumn{1}{l|}{AF Details 2} \\ \hline
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} \\ \hline
\multicolumn{1}{|c|}{\multirow{5}{*}{Sun Sensor}} & \multicolumn{1}{l|}{GS5} & \multicolumn{1}{l|}{PC0} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{ADC} & \multicolumn{1}{l|}{ADC\_Resolution\_8b} & \multicolumn{1}{l|}{Channel10} \\ \cline{2-7} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{GS4} & \multicolumn{1}{l|}{PC1} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{ADC} & \multicolumn{1}{l|}{ADC\_Resolution\_8b} & \multicolumn{1}{l|}{Channel 11} \\ \cline{2-7} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{GS3} & \multicolumn{1}{l|}{PC5} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{ADC} & \multicolumn{1}{l|}{ADC\_Resolution\_8b} & \multicolumn{1}{l|}{Channel 15} \\ \cline{2-7} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{GS2} & \multicolumn{1}{l|}{PB0} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{ADC} & \multicolumn{1}{l|}{ADC\_Resolution\_8b} & \multicolumn{1}{l|}{Channel 8} \\ \cline{2-7} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{GS1} & \multicolumn{1}{l|}{PB1} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{ADC} & \multicolumn{1}{l|}{ADC\_Resolution\_8b} & \multicolumn{1}{l|}{Channel 9} \\ \hline
\multicolumn{1}{l}{} &  &  &  &  &  &  \\ \hline
\multicolumn{1}{|c|}{\multirow{6}{*}{PWM}} & \multicolumn{1}{l|}{F1} & \multicolumn{1}{l|}{PB14} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{TIM1} & \multicolumn{1}{l|}{Output Compare} & \multicolumn{1}{l|}{} \\ \cline{2-7} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{R1} & \multicolumn{1}{l|}{PB13} & \multicolumn{1}{l|}{0 or 1} & \multicolumn{1}{l|}{N/A} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} \\ \cline{2-7} 
