...
int16_t getValue_adc(uint8_t channel_number); //Getting the value of the ADC after conversion and sending it to the USART

int16_t *getallValues_adc(int16_t *data); //Get values from the 5 sun sensors and store them in an array
